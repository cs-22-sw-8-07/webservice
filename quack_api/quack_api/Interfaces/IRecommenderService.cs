...
namespace quack_api.Interfaces
{
    public interface IRecommenderService
    {
        ...
        /// <returns></returns>
        public Task<ServiceResponse<PlaylistDTO>> GetPlaylist(RecommenderSettings recommenderStetting, string accessToken, QuackLocationType location, int amount, int offset);
